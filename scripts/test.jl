...
indicator_grid[1,3] = true                                                               # obstacle at position 4,4
...
robot_ics = [
    ROBOT_AT(2,19), # robot 1 starts at vertex 2
    ROBOT_AT(1,22), # robot 2 starts at vertex 9
]

## Define the manufacturing project
spec = ProjectSpec()
# set initial conditions of "raw materials"
set_initial_condition!(spec,OBJECT_AT(1,16)) # object 1 starts at vertex 4
set_initial_condition!(spec,OBJECT_AT(2,13))  # object 2 starts at vertex 
...
# inputs
set_precondition!(op1,OBJECT_AT(1,4))
set_precondition!(op2,OBJECT_AT(2,7)) 
